...
final case class ApplicationUpdatedEvent(
    ...
    with com.trueaccord.scalapb.Message[ApplicationUpdatedEvent]
    with com.trueaccord.lenses.Updatable[ApplicationUpdatedEvent] {
  @transient
...
object ApplicationUpdatedEvent
  ...
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[
    org.zalando.komang.protobuf.Events.ApplicationUpdatedEvent] = this
  def fromFieldsMap(
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    EventsProto.javaDescriptor.getMessageTypes.get(1)
  ...
  implicit class ApplicationUpdatedEventLens[UpperPB](
      _l: _root_.com.trueaccord.lenses.Lens[UpperPB, org.zalando.komang.protobuf.Events.ApplicationUpdatedEvent])
      extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB,
                                                      org.zalando.komang.protobuf.Events.ApplicationUpdatedEvent](_l) {
