...
final case class ConfigNameUpdatedEvent(
    ...
    with com.trueaccord.scalapb.Message[ConfigNameUpdatedEvent]
    with com.trueaccord.lenses.Updatable[ConfigNameUpdatedEvent] {
  @transient
...
object ConfigNameUpdatedEvent
    extends com.trueaccord.scalapb.GeneratedMessageCompanion[org.zalando.komang.protobuf.Events.ConfigNameUpdatedEvent] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[
    org.zalando.komang.protobuf.Events.ConfigNameUpdatedEvent] = this
  def fromFieldsMap(
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    EventsProto.javaDescriptor.getMessageTypes.get(5)
  ...
  implicit class ConfigNameUpdatedEventLens[UpperPB](
      _l: _root_.com.trueaccord.lenses.Lens[UpperPB, org.zalando.komang.protobuf.Events.ConfigNameUpdatedEvent])
      extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB,
                                                      org.zalando.komang.protobuf.Events.ConfigNameUpdatedEvent](_l) {
