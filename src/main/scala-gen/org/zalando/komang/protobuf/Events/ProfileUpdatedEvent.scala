...
@SerialVersionUID(0L)
final case class ProfileUpdatedEvent(
    applicationId: String = "",
    profileId: String = "",
    name: String = ""
) extends com.trueaccord.scalapb.GeneratedMessage
    with com.trueaccord.scalapb.Message[ProfileUpdatedEvent]
    with com.trueaccord.lenses.Updatable[ProfileUpdatedEvent] {
  @transient
  ...
  def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream)
    : org.zalando.komang.protobuf.Events.ProfileUpdatedEvent = {
  ...
  def withApplicationId(__v: String): ProfileUpdatedEvent = copy(applicationId = __v)
  def withProfileId(__v: String): ProfileUpdatedEvent = copy(profileId = __v)
  def withName(__v: String): ProfileUpdatedEvent = copy(name = __v)
  ...
  def companion = org.zalando.komang.protobuf.Events.ProfileUpdatedEvent
}

object ProfileUpdatedEvent
    extends com.trueaccord.scalapb.GeneratedMessageCompanion[org.zalando.komang.protobuf.Events.ProfileUpdatedEvent] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[
    org.zalando.komang.protobuf.Events.ProfileUpdatedEvent] = this
  def fromFieldsMap(
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    EventsProto.javaDescriptor.getMessageTypes.get(3)
  ...
  lazy val defaultInstance = org.zalando.komang.protobuf.Events.ProfileUpdatedEvent(
    )
  implicit class ProfileUpdatedEventLens[UpperPB](
      _l: _root_.com.trueaccord.lenses.Lens[UpperPB, org.zalando.komang.protobuf.Events.ProfileUpdatedEvent])
      extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB, org.zalando.komang.protobuf.Events.ProfileUpdatedEvent](
        _l) {
