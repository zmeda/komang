...
final case class ApplicationCreatedEvent(
    ...
    with com.trueaccord.scalapb.Message[ApplicationCreatedEvent]
    with com.trueaccord.lenses.Updatable[ApplicationCreatedEvent] {
  @transient
...
object ApplicationCreatedEvent
  ...
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[
    org.zalando.komang.protobuf.Events.ApplicationCreatedEvent] = this
  def fromFieldsMap(
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    EventsProto.javaDescriptor.getMessageTypes.get(0)
  ...
  implicit class ApplicationCreatedEventLens[UpperPB](
      _l: _root_.com.trueaccord.lenses.Lens[UpperPB, org.zalando.komang.protobuf.Events.ApplicationCreatedEvent])
      extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB,
                                                      org.zalando.komang.protobuf.Events.ApplicationCreatedEvent](_l) {
