...
final case class ConfigTypeUpdatedEvent(
    ...
    with com.trueaccord.scalapb.Message[ConfigTypeUpdatedEvent]
    with com.trueaccord.lenses.Updatable[ConfigTypeUpdatedEvent] {
  @transient
...
object ConfigTypeUpdatedEvent
    extends com.trueaccord.scalapb.GeneratedMessageCompanion[org.zalando.komang.protobuf.Events.ConfigTypeUpdatedEvent] {
  implicit def messageCompanion: com.trueaccord.scalapb.GeneratedMessageCompanion[
    org.zalando.komang.protobuf.Events.ConfigTypeUpdatedEvent] = this
  def fromFieldsMap(
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor =
    EventsProto.javaDescriptor.getMessageTypes.get(6)
  ...
  implicit class ConfigTypeUpdatedEventLens[UpperPB](
      _l: _root_.com.trueaccord.lenses.Lens[UpperPB, org.zalando.komang.protobuf.Events.ConfigTypeUpdatedEvent])
      extends _root_.com.trueaccord.lenses.ObjectLens[UpperPB,
                                                      org.zalando.komang.protobuf.Events.ConfigTypeUpdatedEvent](_l) {
